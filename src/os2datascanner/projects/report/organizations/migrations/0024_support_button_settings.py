# Generated by Django 3.2.11 on 2023-10-09 05:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('NO', 'None'), ('SD', 'Single DPO'), ('UD', 'Unit DPO')], default='NO', max_length=2, verbose_name='DPO contact style'),
        ),
        migrations.AddField(
            model_name='organization',
            name='dpo_name',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('NO', 'None'), ('WS', 'Website'), ('EM', 'Email')], default='NO', max_length=2, verbose_name='support contact style'),
        ),
        migrations.AddField(
            model_name='organization',
            name='support_name',
