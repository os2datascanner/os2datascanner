...
new Chart(criticalHandledDoughnutChartCtx, {
	...
	data: {
		datasets: [{
			...
			backgroundColor: [colorFunction('--color-error'), colorFunction('--color-grey-light')],
			borderWidth: 0
		}]
	},
	options: {
...
new Chart(problemHandledDoughnutChartCtx, {
	...
	data: {
		datasets: [{
			...
			backgroundColor: [colorFunction('--color-problem'), colorFunction('--color-grey-light')],
			borderWidth: 0
		}]
	},
	options: {
...
new Chart(warningHandledDoughnutChartCtx, {
	...
	data: {
		datasets: [{
			...
			backgroundColor: [colorFunction('--color-warning'), colorFunction('--color-grey-light')],
			borderWidth: 0
		}]
	},
	options: {
...
new Chart(notificationHandledDoughnutChartCtx, {
	...
	data: {
		datasets: [{
			...
			backgroundColor: [colorFunction('--color-notification'), colorFunction('--color-grey-light')],
			borderWidth: 0
		}]
	},
	options: {
